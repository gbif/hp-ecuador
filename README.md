...
[![Build Status](https://builds.gbif.org/job/hp-ecuador/badge/icon)](https://builds.gbif.org/job/hp-ecuador/lastBuild/console)
...
# GBIF Hosted Portal: ecuador

This Jekyll website, **[ecuador (Staging)](https://ecuador.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
